...
with open('/src/assets/token.txt', 'r') as token_file:
...
def inline_query(bot, update):
	...
	results = [
		InlineQueryResultArticle(
			id='mini',
			title='Mini Zalgo',
			input_message_content=InputTextMessageContent(zalgo_text(query, 0))
		),
		InlineQueryResultArticle(
			id='normal',
			title='Normal Zalgo',
			input_message_content=InputTextMessageContent(zalgo_text(query, 1))
		),
		InlineQueryResultArticle(
			id='mega',
			title='Mega Zalgo',
			input_message_content=InputTextMessageContent(zalgo_text(query, 2))
		)
	]
